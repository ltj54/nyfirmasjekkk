...
public final class SalesSegmentCatalog {
    private static final SalesSegment HANDVERK = new SalesSegment(
            ...
            "Jeg lager nettsider for bygg- og håndverksbedrifter med tjenester, kontaktinfo, område dere dekker og en ryddig profil som gjør det lettere å bli funnet på Google. Da får dere også en fast nettside å vise til i e-post, tilbud, sosiale medier og annen kundekontakt."
    );
    private static final SalesSegment RENHOLD_OG_DRIFT = new SalesSegment(
            ...
            "Jeg lager nettsider for renhold og drift med tjenestene dere tilbyr, område dere dekker og tydelig kontaktinfo. Da får dere en fast nettside som kan brukes i e-post, tilbud, sosiale medier og annen kundekontakt."
    );
    private static final SalesSegment HAGE_OG_GRONTANLEGG = new SalesSegment(
            ...
            "Jeg lager nettsider for gartner- og hagebedrifter med tjenester, område dere dekker, kontaktinfo og en ryddig profil. Da får dere en fast nettside som kan brukes i e-post, tilbud, sosiale medier og annen kundekontakt."
    );
    private static final SalesSegment PERSONLIG_TJENESTE = new SalesSegment(
            ...
            "Jeg lager profesjonelle nettsider med behandlinger/tjenester, kontaktinfo, åpningstider og lenke til booking hvis du bruker det. Da får du en fast nettside å vise til i e-post, sosiale medier og annen kundekontakt."
    );
    ...
    private static final SalesSegment BUTIKK_LOKALHANDEL = new SalesSegment(
            ...
            "Jeg lager nettsider med hva butikken tilbyr, åpningstider, kontaktinfo og en ryddig profil som gjør det lettere å finne dere lokalt. Da får dere en fast nettside å vise til i sosiale medier, e-post og annen kundekontakt."
    );
    private static final SalesSegment TRANSPORT = new SalesSegment(
            ...
            "Jeg lager nettsider med transporttjenestene dere tilbyr, område dere dekker og tydelig kontaktinfo. Da får dere en fast nettside å vise til i e-post, tilbud og annen kundekontakt."
    );
    private static final SalesSegment EIENDOM = new SalesSegment(
            ...
            "Jeg lager nettsider med presentasjon av virksomheten, kontaktinfo og en ryddig profil. Da får dere en fast nettside å vise til i e-post, tilbud og annen kundekontakt."
    );
    ...
    private static final SalesSegment FORENING_KLUBB = new SalesSegment(
            ...
            "Jeg lager klubbsider med treningstider, kontaktpersoner, medlemsinfo, sponsorer og lenker til Spond/Facebook. Da får dere en fast nettside å vise til i e-post, sosiale medier og medlemsinformasjon."
    );
