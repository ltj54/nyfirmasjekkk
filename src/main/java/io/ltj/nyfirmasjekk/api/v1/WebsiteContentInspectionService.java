...
public class WebsiteContentInspectionService {
    ...
    public record WebsiteContentSnapshot(
            ...
            boolean sourceMapReferenceSignal,
            boolean developmentReferenceSignal,
            int targetBlankWithoutNoopenerCount,
            boolean personalDataGetFormSignal,
            boolean externalFormActionSignal,
            boolean noIndexSignal,
            boolean sitemapSignal,
            int inlineEventHandlerCount,
            int javascriptHrefCount,
            boolean domXssSinkSignal,
            boolean clientUrlInputSignal,
            int externalScriptsWithoutIntegrityCount,
            int thirdPartyScriptHostCount,
            int inlineScriptCount,
            int postFormsWithoutCsrfTokenCount,
            boolean outdatedJavascriptLibrarySignal,
            ...
            boolean spfTooManyLookupsSignal,
            boolean duplicateSpfRecordSignal,
            boolean dmarcPolicyNoneSignal,
            boolean dmarcRuaMissingSignal,
        ...
        public WebsiteContentSnapshot(
            ...
            this(title, bodyText, "", html, metaDescription, viewport, language, h1,
                    ...
                    false, false, false, false, false, false,
                    0, 0, 0,
                    false, false, false, 0, false, false, false, 0, false, false, false, false, 0, 0, false, false, 0, 0, 0, 0, false, false, false, null,
