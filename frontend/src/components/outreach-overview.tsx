    ...
    <section className="mx-auto max-w-7xl px-6 py-8" id="outreach">
      <div className="flex flex-col gap-4 border-b border-[#D9E2EC] pb-5 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <p className="mt-2 text-[13px] text-[#52606D]">Siste status per virksomhet. Oppfølging kan sendes 4–14 arbeidsdager etter tilbudet.</p>
        </div>
      ...
      <div className="mt-6 border border-[#C7DFF8] bg-[#F8FBFF] p-4">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-[12px] text-[#52606D]">Én oppfølging per virksomhet, innen 4–14 arbeidsdager etter tilbudet. Inntil ti mottakere per utsending.</p>
          </div>
          <Button
