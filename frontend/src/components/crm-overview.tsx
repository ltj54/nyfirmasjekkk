...
const projects: CrmProject[] = [
  ...
  },
  {
    ...
    replyDate: "21.09.2026 kl. 09:12",
    sentProposalDate: "21.09.2026 kl. 11:02",
    outreach: "Positiv interesse – ber om forslag",
    progress: "Arbeidsbeskrivelse sendt for en profesjonell nettside for bedriftsrådgivning innen fiskeri og marine næringer. Mulig struktur er forside, tjenester/kompetanse, om Gunnar og kontakt.",
    nextStep: "Avventer Gunnars tilbakemelding på arbeidsbeskrivelsen. Videre dialog håndteres manuelt; ingen automatisk oppfølging.",
    invoice: "Ikke fakturert",
    status: "working",
  },
  {
    ...
    nextStep: "Betaling på 1 990 kr antas mottatt 21.09.2026; bankdetaljene må bekreftes før fakturaen settes endelig som betalt. Eventuelle innholdsendringer håndteres manuelt.",
    ...
    invoice: "Antatt betalt – avventer bankbekreftelse · 1 990 kr",
    status: "payment",
  },
  {
