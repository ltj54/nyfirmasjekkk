...
const projects: CrmProject[] = [
  ...
  },
  {
    ...
    progress: "Ønsker eksklusiv én-forside på norsk og engelsk med KI-musikkproduksjon, Broken Veil, Black Veil Hart, rådgivning, publishing og Spotify-/artistlenker.",
    nextStep: "Oppdatert versjon og domeneveiledning sendt 14.09.2026. Avventer domenevalg hos Henning før publisering på eget domene; ingen automatisk oppfølging.",
    invoice: "Ikke fakturert",
    tone: "border-blue-200 bg-blue-50",
  },
  {
