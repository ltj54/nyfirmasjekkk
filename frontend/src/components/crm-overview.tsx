...
const projects: CrmProject[] = [
  ...
  },
  {
    ...
    outreach: "Kvalifisert interesse – krav avklart",
    progress: "Ønsker eksklusiv én-forside på norsk og engelsk med KI-musikkproduksjon, Brøken Veil, Black Veil Hart, rådgivning, publishing og Spotify-/artistlenker.",
    nextStep: "Førsteutkast sendt 13.09.2026. Avventer Henning manuelt; ingen automatisk oppfølging.",
    invoice: "Ikke fakturert",
    tone: "border-blue-200 bg-blue-50",
  },
  {
  ...
  },
  {
    ...
    nextStep: "Svar sendt 13.09.2026 med ca. 4–6 timer og fastpris 1 990 kr. Avventer Knut manuelt; ingen automatisk oppfølging.",
    invoice: "Ikke fakturert",
    tone: "border-blue-200 bg-blue-50",
  },
