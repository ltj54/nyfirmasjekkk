...
const projects: CrmProject[] = [
  ...
  },
  {
    ...
    progress: "Første arbeidsutkast sendt 23.09.2026 på ltj54.github.io/fiskerikandidat-gunnar-davidsson. Gunnar ønsker en enkel, mest mulig frossen nettside med kontaktinformasjon og tjenester innen fiskeri og marine næringer, samt minimalt vedlikehold. Han har et eget bildebibliotek.",
    nextStep: "Avventer Gunnars vurdering av helhetsinntrykk, tjenester og bakgrunnstekst. Deretter må bilder, kontaktopplysninger, e-postfunksjon, eventuelle faglenker, davidsson.no og permanent hosting avklares. Avtaleutkast ligger i prosjektet og sendes etter behovsavklaring. Videre dialog håndteres manuelt; ingen automatisk oppfølging.",
    invoice: "Ikke fakturert",
