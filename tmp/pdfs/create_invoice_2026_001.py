...
OUTPUT = "output/pdf/faktura-2026-001-breathe-senja-betalt.pdf"
...
doc = SimpleDocTemplate(
    ...
    topMargin=18 * mm,
    bottomMargin=18 * mm,
    title="Faktura 2026-001 - Breathe Senja & Services Henriksen",
...
meta = [
    [Paragraph("<b>Fakturanr.</b><br/>2026-001", styles["Body"]), Paragraph("<b>Fakturadato</b><br/>06.07.2026", styles["Body"]), Paragraph("<b>Forfallsdato</b><br/>20.07.2026", styles["Body"]), Paragraph("BETALT", styles["Status"])],
]
...
parties = Table([
    [Paragraph("<b>Fra</b><br/>LTJ-Production<br/>v/ Lars Tangen Johannessen<br/>E-post: kontakt@ltj-production.no<br/>Org.nr.: Ikke oppgitt i grunnlaget<br/>Kontonr.: 6098.08.05657", styles["Body"]), Paragraph("<b>Til</b><br/>Breathe Senja &amp; Services Henriksen<br/>v/ Roland Henriksen<br/>Org.nr.: 937 296 355<br/>Telefon: +47 46 54 45 10<br/>E-post: roland.henriksen75@gmail.com", styles["Body"])],
...
lines = [
    ...
    [Paragraph("Nettside for Breathe Senja - design, tekst/struktur, bildearbeid, publisering og teknisk oppsett.", styles["Body"]), Paragraph("1", styles["Right"]), Paragraph(PRICE_TEXT, styles["Right"]), Paragraph(PRICE_TEXT, styles["Right"])],
]
...
payment = Table([
    [Paragraph("<b>Betaling</b><br/>Betalt. Opprinnelig betalingsfrist var 20.07.2026.<br/>Betalingsdato er ikke oppgitt i grunnlaget.<br/><br/><b>Merknad:</b> Ikke MVA-registrert.", styles["Body"]), Paragraph("<b>Arkivstatus</b><br/>Sendt og betalt", styles["Body"])],
...
story.append(Paragraph("Dokumentert for intern fakturakontroll. Org.nr. for LTJ-Production må fylles inn dersom fakturaen skal gjenbrukes som mal.", styles["Small"]))
