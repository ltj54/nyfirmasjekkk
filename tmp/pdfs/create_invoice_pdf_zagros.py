...
OUTPUT = Path(r"C:\Prosjekt\zagros-forlag\docs\faktura-2026-002-zagros-forlag.pdf")
...
text(68, 672, "2026-002", 10)
text(190, 688, "Fakturadato", 8, True)
text(190, 672, "03.09.2026", 10)
text(312, 688, "Forfallsdato", 8, True)
text(312, 672, "17.09.2026", 10)
...
text(310, 610, "Zagros Forlag & Oversettelse", 9, True)
text(310, 596, "v/ Eisa Bazyar", 9)
text(310, 582, "Org.nr.: Ikke oppgitt i grunnlaget", 9)
text(310, 568, "E-post: post@zagrosforlag.no", 9)
line(56, 536, 539, 536)
...
line(56, 468, 539, 468)
text(68, 448, "Nettside for Zagros Forlag - design, struktur,", 9)
text(68, 434, "flerspråklig innhold, publisering, domene og Formspree.", 9)
text(423, 441, "1", 9)
...
text(68, 264, "Vennligst betal 1 990,00 kr innen 17.09.2026.", 9)
text(68, 250, "Merk betalingen med fakturanummer: 2026-002.", 9)
text(68, 232, "Merknad: Ikke MVA-registrert.", 9)
text(405, 270, "Arkivstatus", 9, True, blue)
text(405, 252, "Klar for utsending", 10, True, green)

text(56, 184, "Dokumentert for intern fakturakontroll.", 8, False, (0.3, 0.36, 0.38))
text(56, 170, "Org.nr. for LTJ-Production og kunden bør fylles inn før utsending ved behov.", 8, False, (0.3, 0.36, 0.38))
